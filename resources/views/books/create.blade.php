    ...
    <div class="container">
        ...
        <form method="POST" action="/books">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Enter book title">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" id="cover_url" name="cover_url" value="{{ old('cover_url') }}" placeholder="https://example.com/book-cover.jpg" onchange="previewImage()">
